        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Draft Raperkada <?= $cek_nama_panjang_zona->row()->nama_panjang ?></h4>
                ...
                <div class="panel-body">
                        ...
                        if ($this->session->userdata('level') != "perancang") {
                            ...
                            <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?= $link3; ?>/t.html"
                               class="btn btn-primary"><i
                                        class="fa fa-plus-circle"></i> Tambah Dokumen Draft Raperkada </a>
                            <?php
                        }
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <!--'belum_diproses','perbaikan','draft_sedang_dibuat','menunggu_koreksi','selesai'-->
                            <select class="form-control default-select2" id="stt" name="stt"
                                    onchange="window.location.href='pemda_raperkada/draft/<?= $link3 ?>/id/'+this.value;">
                                    ...
                                    <td align="center">
                                        ...
                                        <?php if ($_SESSION['level'] != "perancang") { ?>
                                            <a
                                                ...
                                                <?php } ?>
                                                    ...
                                                    data-target="#delete_confirm<?php echo hashids_encrypt($baris->id_draft_permohonan); ?>"
                                            ><i class="fa fa-trash-o"></i
                                                ></a>


                                            <a title="Edit Perancang"
                                               href="pemda_raperkada/draft/<?= $link3; ?>/ce_perancang/<?= hashids_encrypt($baris->id_draft_permohonan); ?>"
                                        ...
                                        if ($baris->status != "selesai") {
                                            ...
                                            <a title="Edit Kasub Perancang"
                                               href="pemda_raperkada/draft/<?= $link3; ?>/ce_kasub_perancang/<?= hashids_encrypt($baris->id_draft_permohonan); ?>"
				...
				Assalamualaikum,...%0a
				Kami dari *<?= $this->session->userdata('nama_lengkap') ?>*, ingin mengajukan permohonan harmonisasi *RAPERKADA* dengan judul
			...
			" id="kirimWa" name="kirimWa" target="_blank">
				...
				Assalamualaikum,...%0a
				Telah terdapat pendelegasian harmonisasi *RAPERKADA* dari *<?= $this->session->userdata('nama_lengkap') ?>*, dengan judul draft
				<?php echo " *" . $baris->nama_draft_permohonan ?>*, %0a
			...
			" id="kirimWa" name="kirimWa" target="_blank">
                                ...
                                <div class="modal fade" id="delete_confirm<?php echo hashids_encrypt($baris->id_draft_permohonan); ?>">
                                    <div class="modal-dialog" role="document">
                                        <!--                                        --><? //= $zona_document;
                                        ?>
                                        <div class="modal-content">
                                            <div class="bd p-15"><h5 class="m-0">Hapus Data Raperkada</h5></div>
                                            <div class="modal-body">
                                                ...
                                                <form method="POST"
                                                    ...
                                                    <div>Apakah Anda yakin akan menghapus data draft
                                                        Raperkada <?= ucfirst($cek_nama_panjang_zona->result()[0]->nama_panjang); ?>
                                                        ini?
                                                    </div>
                                                    <hr>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header" style="background-color: #225fd5">
                                                ...
                                                <h4 class="modal-title" style="color: white">Detail Draft Raperkada</h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="form-horizontal">
                                                    ...
                                                    <span style="font-weight: bold; font-size: 15px">Surat Permohonan</span>
                                                    <br>
                                                    <div style="height: 15px"></div>
                                                    ...
                                                    <div class="form-group col-lg-12"
                                                        ...
                                                        <div class="row m-l-1" style=" overflow: hidden;  ">
                                                            <?php if ($baris->lamp_surat_permohonan == null || $baris->lamp_surat_permohonan == "") {
                                                                ?>
                                                    ...
                                                    <span style="font-weight: bold; font-size: 15px">Naskah Akademik / Penjelasan / Keterangan</span>
                                                    <br>
                                                    <div style="height: 15px"></div>
                                                    ...
                                                    <!---->
                                                    <span style="font-weight: bold; font-size: 15px">Rancangan Perkada</span>
                                                    <br>
                                                    <div style="height: 15px"></div>
                                                    ...
                                                    <div class="form-group col-lg-12"
                                                         style="justify-items: end; background-color: ">
                                                        <div class="row m-l-1" style=" overflow: hidden;  ">
                                                            <?php if ($baris->rancangan_perkada == null || $baris->rancangan_perkada == "") {
                                                                ?>
                                                                ...
                                                                <a style="text-decoration: none"
                                                                   href="<?php echo base_url($baris->rancangan_perkada); ?>"
                                                                   target="_blank">
                                                                    <i class="fa fa-check-square"
                                                                       style="margin-right: 15px"></i>
                                                                    <?= explode('/', $baris->rancangan_perkada)[2]; ?>
